        ...
        <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
          <Card className="text-center hover:shadow-lg transition-shadow bg-blue-50/50 border-blue-100">
            <CardHeader>
              ...
              <CardTitle className="text-2xl font-semibold">Save Time Every Week</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow bg-green-50/50 border-green-100">
            <CardHeader>
              ...
              <CardTitle className="text-2xl font-semibold">Simplify Operations</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow bg-purple-50/50 border-purple-100">
            <CardHeader>
              ...
              <CardTitle className="text-2xl font-semibold">Continuous Partnership</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base leading-relaxed">
